...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h3 align="center" class="text-danger">HE PERDIDO</h3>
      </div>
      <div class="col-lg-3">
    ...
    <form action="buscar.php" method="post" enctype="multipart/form-data" id="f1" name="f1">
    <div class="row">
       ...
       <div class="col-lg-12">
          <div class="row">
              <div class="col-lg-6">
                  <label class="text-info"> Categoria *</label>
                    <select class="form-control" name="categoria" id="categorias" onchange="cambia_categoria()" required="required">
              ...
              <div class="col-lg-6">
                  <label class="text-info"> SubCategoria *</label>
                    <select class="form-control" name="subcategoria" id="subcategorias" required="required">
          ...
          <div class="row">
              ...
              <div class="col-sm-3">
                <center><input type="submit" value="BUSCAR" class="btn btn-primary btn-block " name="Siguiente"></center>
              </div>
              <div class="col-sm-3">
